...
public class RCC_CinematicCamera : RCC_Singleton<RCC_CinematicCamera> {
    ...
    private void Update() {
        ...
        transform.rotation = Quaternion.Slerp(transform.rotation, Quaternion.Euler(transform.eulerAngles.x, target.eulerAngles.y + 180f, transform.eulerAngles.z), Time.deltaTime * 2f);
