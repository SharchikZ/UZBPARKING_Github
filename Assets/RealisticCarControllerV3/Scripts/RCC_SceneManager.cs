...
public class RCC_SceneManager : RCC_Singleton<RCC_SceneManager> {
    ...
    {
        activePlayerVehicle.transform.rotation = Quaternion.Euler(0f, activePlayerVehicle.transform.eulerAngles.y, 0f);
        activePlayerVehicle.transform.position = new Vector3(activePlayerVehicle.transform.position.x, activePlayerVehicle.transform.position.y + 3, activePlayerVehicle.transform.position.z);
    }
    private void Update() {
    ...
    {
        activePlayerVehicle.canControl = true;
    }

    public void CanControlOFF()
    {
        activePlayerVehicle.canControl = false;
    }
