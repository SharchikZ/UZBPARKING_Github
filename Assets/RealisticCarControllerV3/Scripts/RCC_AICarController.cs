...
public class RCC_AICarController : MonoBehaviour {
    ...
    private void FixedRaycasts() {
        ...
        int[] anglesOfRaycasts = new int[10];
        ...
        anglesOfRaycasts[5] = Mathf.FloorToInt(raycastAngle / .5f);
        anglesOfRaycasts[6] = Mathf.FloorToInt(raycastAngle / .6f);
        anglesOfRaycasts[7] = -Mathf.FloorToInt(raycastAngle / .5f);
        anglesOfRaycasts[8] = -Mathf.FloorToInt(raycastAngle / .6f);
        anglesOfRaycasts[9] = -Mathf.FloorToInt(raycastAngle / .9f);
