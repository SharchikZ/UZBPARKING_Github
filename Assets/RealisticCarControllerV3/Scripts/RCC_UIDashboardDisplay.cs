        ...
        if (leftIndicator && rightIndicator) {
            ...
            switch (Inputs.indicators) {
                ...
                case RCC_CarControllerV3.IndicatorsOn.Left:
                    leftIndicator.color = new Color(255f, 255f, 0f);
                    rightIndicator.color = new Color(255f, 255f, 255f);
                    break;
                case RCC_CarControllerV3.IndicatorsOn.Right:
                    leftIndicator.color = new Color(255f, 255f, 255f);
                    rightIndicator.color = new Color(255f, 255f, 0f);
                    break;
