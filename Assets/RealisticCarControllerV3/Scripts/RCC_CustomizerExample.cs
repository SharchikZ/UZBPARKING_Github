...
public class RCC_CustomizerExample : RCC_Singleton<RCC_CustomizerExample> {
    ...
    public Slider frontOffset;
    public Slider rearOffset;
    ...
    public void CheckUIs() {
        ...
        if (frontOffset)
            frontOffset.SetValueWithoutNotify(RCC_SceneManager.Instance.activePlayerVehicle.FrontLeftWheelCollider.wheelOffset);

        if (rearOffset)
            rearOffset.SetValueWithoutNotify(RCC_SceneManager.Instance.activePlayerVehicle.RearLeftWheelCollider.wheelOffset);
    ...
    public void SetFrontOffsetBySlider(Slider slider)
    {

        RCC_Customization.SetFrontOffset(RCC_SceneManager.Instance.activePlayerVehicle, slider.value);

    }

    public void SetRearOffsetBySlider(Slider slider)
    {

        RCC_Customization.SetRearOffset(RCC_SceneManager.Instance.activePlayerVehicle, slider.value);
